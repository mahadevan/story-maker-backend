...
async def generate_treatment(plot_text: str) -> str:
    ...
    prompt = f"""Using the following plot idea, write a complete short story of up to 350 words in Malayalam Language. The story should have a clear beginning, middle, and end. Also add an appropriate title. Include appropriate emojis in the storytelling.
